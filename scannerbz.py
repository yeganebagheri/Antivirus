...
while(1):
    ascii_banner = pyfiglet.figlet_format("scannerbz")
    print(Fore.CYAN + ascii_banner)
    print(Fore.MAGENTA , "[Virus Scanner]  \n \n")
    print(Fore.WHITE)
    BUF_SIZE = 65536
    sha1 = hashlib.sha1()
        ...
        with Virustotal(API_KEY=APIKey, API_VERSION="v3") as vtotal:
            ...
            #  print(serverresponse)
             ...
             if((serverresponse.count("'category': 'malicious'")) >= 5):
                 print(Fore.LIGHTRED_EX,"This file is flagged1 by " , (serverresponse.count("'category': 'malicious'")) , " antivirus softwares as malicious")
             elif((serverresponse.count("'category': 'malicious'")) >= 2):
                print(Fore.LIGHTYELLOW_EX ,"This file is flagged2 by " , (serverresponse.count("'category': 'malicious'")) , " antivirus softwares as malicious")
             elif((serverresponse.count("'category': 'malicious'")) == 1):
                 print(Fore.LIGHTWHITE_EX ,"This file is flagged3 by " , (serverresponse.count("'category': 'malicious'")) , " antivirus software as malicious")
             else:
                 print(Fore.LIGHTGREEN_EX ,"This file is flagged4 by " , (serverresponse.count("'category': 'malicious'")) , " antivirus softwares as malicious")
        print(Fore.WHITE)
    except:
    ...
    my_list = list(resp.data.values())
    # print(my_list)
    # serverresponse = str(resp.data.ljust("'category': 'malicious'"))
